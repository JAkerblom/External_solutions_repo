...
namespace Endpoint_Cmd
{
    class Program
    {
        static void Main(string[] args)
        {
            const string endpointName = "retraining";
            const string workspaceId = "3fadc55951da46828a105146f089a9f5";//From workspace settings
            const string workspaceToken = "KFsIV3fOWGHJECLKk/lbT38e73gBdEfZb8z9U0YQGw9sdD0XgR6S3FlcGaA9N9mE14m/9XGX/xm8QegR2on+jQ==";//From Settings, Auth Token
            const string webserviceId = "24ef1e84af264a34a08c08feacef5329";//From Azure portal or help page url of the service after /webservices/
